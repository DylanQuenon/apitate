 ...
 */
final class Version20260707090014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE albums (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, release_date VARCHAR(255) NOT NULL, released_at DATETIME NOT NULL, description LONGTEXT NOT NULL, cover VARCHAR(255) NOT NULL, stream_url VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
