 ...
 */
final class Version20260707090511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE albums DROP release_date');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE albums ADD release_date VARCHAR(255) NOT NULL');
